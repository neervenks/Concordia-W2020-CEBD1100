...
cad_conv = usd_exchange_rates['CAD']
cad_price = cad_conv * item_original_price

m_usd = Money(item_original_price, item_original_currency)
m_cad = Money(str(cad_price), "CAD")

print("Item name:       %s" % (item_name))
print("Original Price:  %s (%s)" % (m_usd.format("en_US"), item_original_currency))
print("Purchased Price: %s (%s)" % (m_cad.format("fr_CA"), item_purchase_currency))
